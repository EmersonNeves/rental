...
class SettingsController extends Controller
{
    ...
    public function paymentMethods(Request $request)
    {
       ...
       $getnet = Settings::where('type', 'getnet')->get()->toArray();
       ...
       $data['getnet'] = $this->helper->key_value('name', 'value', $getnet);
        ...
        //CUSTOM
        elseif ($request['gateway'] == 'getnet') {
          $rules = array(
              'getnet_auth_url'      => 'required',
              'getnet_seller_id'     => 'required',
              'getnet_client_id'     => 'required',
              'getnet_client_secret' => 'required',
              'getnet_checkout_url'  => 'required',
              'getnet_installments'  => 'required',
              'getnet_card_caixa'    => 'required'
          );

          $fieldNames = array(
              'getnet_auth_url'         => 'Getnet Auth URL',
              'getnet_seller_id'        => 'Getnet Seller ID',
              'getnet_client_id'        => 'Getnet Client ID',
              'getnet_client_secret'    => 'Getnet Client Secret',
              'getnet_checkout_url'     => 'Getnet Checkout URL',
              'getnet_disabled_methods' => 'Getnet Disabled Methods',
              'getnet_installments'     => 'Getnet Installments',
              'getnet_card_caixa'       => 'Getnet Virtual Card Caixa'
          );
          ...
          if ($validator->fails()) {
              ...
              if (env('APP_MODE', '') != 'test') {
                  ...
                  Settings::updateOrCreate(['name' => 'getnet_auth_url', 'type' => 'Getnet'],['value' => $request->getnet_auth_url]);
                  Settings::updateOrCreate(['name' => 'getnet_seller_id', 'type' => 'Getnet'],['value' => $request->getnet_seller_id]);
                  Settings::updateOrCreate(['name' => 'getnet_client_id', 'type' => 'Getnet'],['value' => $request->getnet_client_id]);
                  Settings::updateOrCreate(['name' => 'getnet_client_secret', 'type' => 'Getnet'],['value' => $request->getnet_client_secret]);
                  Settings::updateOrCreate(['name' => 'getnet_checkout_url', 'type' => 'Getnet'],['value' => $request->getnet_checkout_url]);
                  Settings::updateOrCreate(['name' => 'getnet_disabled_methods', 'type' => 'Getnet'],['value' => $request->getnet_disabled_methods]);
                  Settings::updateOrCreate(['name' => 'getnet_installments', 'type' => 'Getnet'],['value' => $request->getnet_installments]);
                  Settings::updateOrCreate(['name' => 'getnet_card_caixa', 'type' => 'Getnet'],['value' => $request->getnet_card_caixa]);
                  Settings::updateOrCreate(['name' => 'getnet_status', 'type' => 'Getnet'],['value' => $request->getnet_status]);
