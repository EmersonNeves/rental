                           ...
                           <div class="row svborder" id="daterange-btn">
                              <div class="col-6 p-2">
                                 ...
                                 <div class="mr-2">
                                    ...
                                    <!-- CUSTOM -->
                                    <input class="form-control" id="startDate" name="checkin" value="{{ $checkin ? $checkin : date('Y-m-d') }}" type="text" required>
                              ...
                              <div class="col-6 p-2 border-left-chk">
                                 ...
                                 <div class="ml-2">
                                  ...
                                  <!-- ORIGINAL -->
                                  <!-- <input class="form-control" id="endDate" name="checkout" value="{{ $checkout ? $checkout : date('Y-m-d', time() + 86400) }}" placeholder="dd-mm-yyyy" type="text" required> -->
                                 ...
                                 <tbody>
                                    ...
                                    <tr class="sv_discount">
                                       <td class="pl-4 underline">
                                        ...
                                        <!-- CUSTOM -->
                                        {{ trans('messages.property_single.custom_discount') }}
                  ...
                  <div class="col-md-12 col-sm-12 p-0">
                     <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 p-0">
                           ...
                           <div class="text-15">
                              <strong>{{trans('messages.property_single.bed')}}:</strong> {{ @$result->beds_count }}
                              <ul
                                 class="pl-3"
                                 style="list-style-type: square;">
                              @foreach(@$result->beds as $bed)
                                 <li class="ml-5">
                                    {{ $bed->name }} ({{ $bed->pivot->beds }})
                                 </li>
                              @endforeach
                              </ul>
                           </div>
                              ...
                              <span class="secondary-text-color">
                                 <a href="{{ url('cancellation-policies') }}" class="text-danger" target="_blank">
                                    @if ($result->cancellation == 'Flexible')
                                       {{ trans('messages.property_single.custom_cancellation_flexible') }}
                                    @elseif ($result->cancellation == 'Moderate')
                                       {{ trans('messages.property_single.custom_cancellation_moderate') }}
                                    @elseif ($result->cancellation == 'Strict')
                                       {{ trans('messages.property_single.custom_cancellation_strict') }}
                                    @endif
                                 </a>
                              </span>
                              </strong>
