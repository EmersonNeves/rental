		...
		<section class="sub_header col-md-6 p-0" style="display:none">
			<div class="align-items-center text-center text-md-left svmobsearch desk-search-form container">
				...
				<div class="container">
					...
					<div class="tab-content mr-10 pt-3" id="myTabContent">
						<div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
							<div class="row mb-3">
								<div class="main_formbg item animated zoomIn mob-form-bg col-md-6 mx-auto">
									<form id="front-search-form-home" method="post" action="{{url('search')}}">
										...
										<div class="row">
											...
											<input type="hidden" id="type" name="type" value="<?php if ($type == "") { ?>property<?php } else {
																																echo $type;
																															} ?>">

											<div class="col-2 pl-0 front-search">
												<button type="submit" class="btn vbtn-default btn-block h-100"><i class="fa fa-search"></i></button>
											</div>
										</div>
									</form>
								</div>
				...
				<div class="modal-body">
					<div class="d-flex justify-content-center p-5">
						<div class=" mb-5">
							...
							<?php if (isset($phoneSms['status'])) {
								if ($phoneSms['status'] == '1') { ?>
	...
	<script>
		...
		$(document).ready(function() {
			$("#pno").intlTelInput({
				...
				nationalMode: true,
				preferredCountries: ["<?php if ($default_country == "") {
											echo "us";
										} else {
...
<?php } else { ?>
	...
	<script type="text/javascript">
		...
		$('#custom_guests_dropdown input[type="text"]').off('input').on('input', function({
			target
		}) {
