				...
				<div class="col-md-12 p-0">
					<div class="main-panel">
						<div class="row justify-content-center">
							<div class="col-md-6 p-0 sv_step_first step-six">
                                <img src="{{ $experience_sixth_img }}" class="img-fluid">
            			        <div>
                       				<h3 class="text-center text-52 font-weight-700">{{trans('messages.listing_basic.property_photos')}}</h3>
                                </div>
							</div>

							<div class="col-md-6 mt-4 mt-sm-0 pl-4 pr-4 pb-5 mb-5">
								<form id="img_form" enctype='multipart/form-data' method="post" action="{{url('experience/'.$result->id.'/'.$step)}}" accept-charset='UTF-8'>
									{{ csrf_field() }}
									<div class="row">
                                                        ...
                                                        <div class="col-md-12 mt-4 p-4 pb-4 pt-4">
                                                            ...
                                                            <!--<div class="row">
                                                                <div class="col-md-9">
                                                                    ...
                                                                    <p class="text-13">{{ trans('messages.experience.width_height') }}
                                                                    </p>
									...
									<div class="row">
                                    	<div class="col-md-12 border mt-4 pb-5 rounded-3 pl-sm-0 pr-sm-0 mob-pd-0">
                                    		<div class="row">
                                    			<div class="form-group col-md-12 main-panelbg pb-3 pt-3 mt-sm-0 ">
                                    				<h4 class="text-18 font-weight-700 pl-3">{{ trans('messages.experience.videos') }}</h4>
                                    			</div>
                                    
                                    			<div class="form-group col-md-12">
                                    				<div class="row">
                                    					<div class="col-md-12 mt-4 p-4 pb-4 pt-4 mob-pd-0">
                                    				
                                    
                                    						<div class="row">
                                    							<div class="col-md-9 col-9">
                                    							
                                    							<input class="form-control text-16" id="video_id" name="video" type="text" placeholder="{{ trans('messages.experience.enter_youtube_link') }}">
                                    							
                                    							
                                    							</div>
                                    							<div class="col-md-3 col-3 mob-pd-0">
                                    							<button type="submit" class="btn btn-large btn-photo text-16" id="vid_button">
                                    								<i class="spinner fa fa-spinner fa-spin d-none" id="up_spin"></i>
                                    								<span id="up_button_txt">{{trans('messages.listing_description.upload')}}</span>
									...
									<div class="col-md-12 p-0 mt-4 mb-5">
										<div class="row m-0 justify-content-between">
											<div class="mt-4">
												<a href="{{ url('experience/'.$result->id.'/amenities') }}" class="btn btn-outline-danger secondary-text-color-hover text-16 font-weight-700  pt-3 pb-3 pl-5 pr-5">
											...
											<div class="mt-4">
												...
												<a href="{{url('experience/'.$result->id.'/pricing')}}" class="btn vbtn-outline-success text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3 pl-5 pr-5" id="btnnext"><i class="spinner fa fa-spinner fa-spin d-none" id="btn_spin"></i>
