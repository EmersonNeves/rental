		...
		<div class="col-md-12 p-0">
				<div class="row min-height">
					<div class="col-md-6 p-0 sv_step_three">
                         <img src="{{ $experience_fourth_img }}" class="img-fluid">
    			        <div>
               				<h3 class="text-center text-52 font-weight-700">{{trans('messages.experience.experience_location')}}</h3>
                        </div>
					</div>

					<div class="col-md-6 mt-4 mt-sm-0 pl-4 pr-4 pb-5">
						<form id="lis_location" method="post" action="{{url('experience/'.$result->id.'/'.$step)}}" accept-charset='UTF-8'>
							{{ csrf_field() }}
							<div class="col-md-12 mt-4  rounded-3 pl-4 pl-sm-0 pr-4 pr-sm-0 mob-pd-0">
								...
								<div class="row mt-4">
									...
									<div class="col-md-6 pr-5 mob-pd">
										...
										<input type="text" name="address_line_1" id="address_line_1" value="{{ $result->property_address->address_line_1  }}" class="form-control text-16 mt-2" placeholder="{{ trans('messages.listing_location.custom_placeholder_address_line_1') }}">
								...
								<div class="row mt-4">
									...
									<div class="col-md-12 mt-4 pl-5 pr-5">
										<p>{{ trans('messages.listing_location.custom_move_pointer') }}</p>
								...
								<div class="row">
									<div class="col-md-6 mt-4 pl-5 pr-5">
										...
										<input type="text" name="address_line_2" id="address_line_2" value="{{ $result->property_address->address_line_2  }}" class="form-control text-16 mt-2" placeholder="{{ trans('messages.listing_location.custom_placeholder_address_line_2') }}">
									</div>
							...
							<div class="col-md-12 p-0 mb-3">
								<div class="row justify-content-between">
									<div class="mt-4 ml-5 mlft-0">
										<a href="{{ url('experience/'.$result->id.'/details') }}" class="btn btn-outline-danger secondary-text-color-hover text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3">
