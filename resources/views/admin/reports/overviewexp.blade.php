...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>Overview & Statisics (Experience)</h1>
	</section>
	...
	<section class="content">
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body">
						<form class="form-horizontal" enctype='multipart/form-data' action="{{ url('admin/overview-stats-experience') }}" method="GET" accept-charset="UTF-8">
							{{ csrf_field() }}
		...
		<div class="row">
			<div class="col-md-8 col-xs-12">
				<div class="box">
					<!-- /.box-header -->
					<div class="box-body">
						<div id="main" class="w-100-p h-100-p" style="width:100%;height:500px;"></div>
						<br>
					</div>
				</div>
			</div>
