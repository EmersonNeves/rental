...
<style>
    .facebook label .text-danger, .google_plus label .text-danger, .twitter label .text-danger, .linkedin label .text-danger, .pinterest label .text-danger, .youtube label .text-danger, .instagram label .text-danger {
        display: none;
    }
</style>
