...
@section('main')
  ...
  <section class="content">
    ...
    <div class="col-md-9">
    <form id="listing_location" method="post" action="{{url('admin/experience/'.$result->id.'/'.$step)}}" class='signup-form login-form' accept-charset='UTF-8'>
      {{ csrf_field() }}
      ...
      <div class="box-body mt-0">
        ...
        <div class="row">
          <div class="col-md-8 mb20">
            ...
            <input type="text" name="address_line_1" id="address_line_1" value="{{ $result->property_address->address_line_1  }}" class="form-control" placeholder="{{ trans('messages.listing_location.custom_placeholder_address_line_1') }}">
        ...
        <div class="row">
          <div class="col-md-8 mb20">
            ...
            <input type="text" name="address_line_2" id="address_line_2" value="{{ $result->property_address->address_line_2  }}" class="form-control" placeholder="{{ trans('messages.listing_location.custom_placeholder_address_line_2') }}">
          </div>
        </div>
        <div class="row">
          <div class="col-md-8 mb20">
        ...
        <div class="row">
          <div class="col-md-6 col-xs-6 text-left">
              <a data-prevent-default="" href="{{ url('admin/experience/'.$result->id.'/details') }}" class="btn btn-large btn-default">{{trans('messages.listing_description.back')}}</a>
          </div>
