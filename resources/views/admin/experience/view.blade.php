    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
              <form class="form-horizontal" enctype='multipart/form-data' action="{{ url('admin/experience') }}" method="GET" accept-charset="UTF-8">
                {{ csrf_field() }}
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Experience Management</h3>
              @if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'add_experience'))
              <div class="pull-right"><a class="btn btn-primary" href="{{ url('admin/add-experience') }}">Add Experience</a></div>
              @endif
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
$(function() {
      ...
      $(document).on("click", "#csv", function(event){
        ...
        window.location = "experience/property_list_csv?to="+to+"&from="+from+"&space_type="+space_type+"&status="+status;
      });
      //pdf convert
      $(document).on("click", "#pdf", function(event){
        ...
        var to = $('#endDate').val();
        var from = $('#startDate').val();
        window.location = "experience/property_list_pdf?to="+to+"&from="+from+"&space_type="+space_type+"&status="+status;
      });
      //reload Datatable
