			...
			<div class="row border rounded p-3">
				...
				<div class="col-md-12 text-center p-0">
					...
					@if(($result->users_verification->email == 'yes') || ($result->users_verification->facebook == 'yes') || ($result->users_verification->google == 'yes'))
						<h3 class="text-center text-17"> <i class="fas fa-check-double"></i> Identity Verified</h3>
					@else
						<h2 class="text-center text-17"> <i class="fa fa-times"></i> {{trans('messages.users_dashboard.identity_unverified')}}</h2>
					@endif
					<hr>
				</div>
				...
				<div class="col-md-12 mt-4 p-0">
					...
					<ul>
						...
						<li class="p-2"><i class="{{ ($result->users_verification->document == 'yes') ? "fa fa-check" : "fa fa-times" }} "></i></i> {{ trans('messages.sign_up.document') }}</li>
