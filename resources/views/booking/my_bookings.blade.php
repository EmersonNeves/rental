...
<div class="margin-top-85">
                                ...
                                <div class="col-md-9 col-xl-8 pl-2">
                                    <div class="row m-0 pr-4">
                                        ...
                                        <div>
                                            ...
                                            <!-- CUSTOM -->
                                            <span class="badge vbadge-success text-13 p-2 {{ $booking->status}}">
                                              {{ trans('messages.booking_my.custom_'.strtolower($booking->status)) }}
                                            </span>
                                        </div>
                                    </div>
                                            ...
                                            <p class="text-14 mt-3">
                                              ...
                                              <?php
                                                ...
                                                if ($current_lang == 'pt')
                                                {
                                                  ...
                                                  echo $booking_type == 'property' ? ' - '.abbrDatePT($booking->end_date) : '';
                                                }
                                                else
                                                {
                                                  echo date(' M d, Y', strtotime($booking->start_date));
                                                  echo $booking_type == 'property' ? ' - '.(date(' M d, Y', strtotime($booking->end_date))) : '';
                                                }
                                              ?>
                                            </p>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form accept-charset="UTF-8" action="{{ url('booking/host_cancel') }}" id="cancel_reservation_form" method="post" name="cancel_reservation_form" onsubmit="$('#cancel_submit i').removeClass('d-none')">
          {{ csrf_field() }}
          ...
          <div class="modal-footer">
            ...
            <button
              id="cancel_submit"
              type="submit"
              class="btn ex-btn text-13 btn-danger font-weight-600">
