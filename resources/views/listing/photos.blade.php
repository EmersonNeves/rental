				...
				<div class="col-md-12 p-0">
					<div class="main-panel">
						<div class="row justify-content-center">
							<div class="col-md-5 p-0 sv_step_first step-six">
                                <img src="{{ $sixth_step }}" class="img-fluid">
            			        <div>
                       				<h3 class="text-center text-52 font-weight-700">{{trans('messages.listing_basic.property_photos')}}</h3>
                                </div> 
							</div>

							<div class="col-md-7 mt-4 mt-sm-0 pl-4 pr-4">
                                                        ...
                                                        <div id="photo-list-div" class="col-md-12 p-0">
                                                            ...
                                                            <div class="row">
                                                                @foreach ($photos as $photo)
                                                                    ...
                                                                    <div class="col-md-4" id="photo-div-{{ $photo->id }}">
                                                                        ...
                                                                        <div class="row mt-3">
                                                                            ...
                                                                            <div class="col-md-6 pl-4 pr-4  pr-sm-0 mt-4 text-14">
                                                                                @if ($photo->cover_photo == 0)
                                                                                    <label
	...
	@push('scripts')
		...
		<script type="text/javascript">
			...
			$(document).on('click', '#img_upload', function(ev){
            	   
    				var dataURL      = '{{url("listing/photo/crop_img_upload")}}';
    				var images       = $('#profile_img_data').val();
    				...
    				else
    				{
        				...
        				$.ajax({
        					url: dataURL,
        					data: {'images':images, 'property_id':property_id, '_token': '{{ csrf_token() }}'},
        					type: 'post',
        					dataType: 'json',
        					success: function (result) {
        						location.reload();
