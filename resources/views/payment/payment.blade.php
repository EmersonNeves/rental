	...
	<div class="row justify-content-center">
		<div class="col-md-8 mb-5 mt-3 main-panel p-5 border rounded">
          ...
          <!-- CUSTOM - ADDRESS NEIGHBORHOOD -->
            ...
            <label>
              {{trans('messages.payment.custom_address_neighborhood')}} <span class="text-danger">*</span>
            </label>
						<input
              required
              type="text"
          ...
          <!-- CUSTOM - ADDRESS COUNTRY -->
            ...
            <label>
              {{trans('messages.payment.custom_address_country')}} <span class="text-danger">*</span>
						...
						<select name="payment_address_country" id="country-select" data-saving="basics1" class="form-control mb20">
...
<script type="text/javascript">
  ...
  {
    $('#checkout-form').validate({submitHandler: (form,e) =>
    {
